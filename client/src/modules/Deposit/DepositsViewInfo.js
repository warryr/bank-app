...
import { endDeposit, getClientDeposits } from 'src/services/api/deposit'
...
class DepositsViewInfo extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      this.props.currentClient.id !== prevProps.currentClient.id &&
      this.props.currentClient.id !== 0
    ) {
      getClientDeposits(this.props.currentClient.id, this.props.setClientDeposits, (error) =>
        console.log(error),
      )
    }
  }
