...
import { addClient } from 'src/services/api/client'
...
import 'flatpickr/dist/themes/light.css' //мб из-за этого??
...
import { CheckboxInput, NumberInput, TextInput } from 'src/common/StatelessComponents'
...
class ClientForm extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <button id="showForm" className="btn btn-light" onClick={ClientForm.toggleForm}>
          Добавить клиента
        </button>
        <form id="clientForm" hidden>
          ...
          <button type="button" className="btn btn-light form-button" onClick={this.onAdd}>
            Добавить
          </button>
        </form>
      </div>
