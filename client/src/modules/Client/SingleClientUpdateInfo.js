...
import { setFieldsFromInput, setFieldsFromSelect, setCheckedIfTrue } from 'src/utils/domUtil'
import { updateClient } from 'src/services/api/client'
...
import {
  ...
  NumberTableInput,
  TextTableInput,
} from '../../common/StatelessComponents'
  ...
  render() {
    ...
    return (
      <div className="view-info">
        <table>
          <tbody>
            <TextTableInput
              id="firstNameUpdated"
              label="Имя: *"
              defaultVal={client.firstName}
              error={errors.firstName}
            />
            <TextTableInput
              id="lastNameUpdated"
              label="Фамилия: *"
              defaultVal={client.lastName}
              error={errors.lastName}
            />
            <TextTableInput
              id="patrNameUpdated"
              label="Отчество: *"
              defaultVal={client.patrName}
              error={errors.patrName}
            />
            <TextTableInput
              id="dateOfBirthUpdated"
              label="Дата рождения: *"
              defaultVal={client.dateOfBirth}
            ...
            <TextTableInput
              id="passportSeriesUpdated"
              label="Серия паспорта: *"
              defaultVal={client.passportSeries}
              error={errors.passportSeries}
            />
            <TextTableInput
              id="passportNumberUpdated"
              label="Номер паспорта: *"
              defaultVal={client.passportNumber}
              error={errors.passportNumber}
            />
            <TextTableInput
              id="dateOfIssueUpdated"
              label="Дата выдачи: *"
              defaultVal={client.dateOfIssue}
              error={errors.dateOfIssue}
            />
            <TextTableInput
              id="issuedByUpdated"
              label="Кем выдан: *"
              defaultVal={client.issuedBy}
              error={errors.issuedBy}
            />
            <TextTableInput
              id="identNumberUpdated"
              label="Идентификационный номер: *"
              defaultVal={client.identNumber}
              error={errors.identNumber}
            />
            <TextTableInput
              id="placeOfBirthUpdated"
              label="Место рождения: *"
              defaultVal={client.placeOfBirth}
              error={errors.placeOfBirth}
            />
            <TableCitySelect
              id="cityOfResidenceUpdated"
              label="Город проживания: *"
              error={errors.cityOfResidence}
            />
            <TextTableInput
              id="residenceAddressUpdated"
              label="Адрес проживания: *"
              defaultVal={client.residenceAddress}
              error={errors.residenceAddress}
            />
            <TextTableInput
              id="statPhoneNumberUpdated"
              label="Домашний телефон: "
              defaultVal={client.statPhoneNumber}
              error={errors.statPhoneNumber}
            />
            <TextTableInput
              id="mobPhoneNumberUpdated"
              label="Мобильный телефон: "
              defaultVal={client.mobPhoneNumber}
              error={errors.mobPhoneNumber}
            />
            <TextTableInput
              id="emailUpdated"
              label="Email: "
              defaultVal={client.email}
              error={errors.email}
            />
            <TableCitySelect
              id="cityOfRegistrationUpdated"
              label="Город проживания: *"
              error={errors.cityOfRegistration}
            />
            <TextTableInput
              id="registrationAddressUpdated"
              label="Адрес прописки: *"
              defaultVal={client.registrationAddress}
              error={errors.registrationAddress}
            />
            <TableMaritalStatusSelect
              id="maritalStatusUpdated"
              label="Семейное положение: *"
              error={errors.maritalStatus}
            />
            <TableCountrySelect
              id="citizenshipUpdated"
              label="Гражданство: *"
            ...
            <NumberTableInput
              ...
              min="0"
              defaultVal={client.monthlyIncome}
        ...
        <button className="btn btn-light form-button" onClick={this.onCancel}>
          Отменить
        </button>
        <button className="btn btn-light form-button" onClick={this.onSave}>
          Сохранить
        </button>
      </div>
    )
